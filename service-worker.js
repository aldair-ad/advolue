...
// Versão bumpada pra forçar a limpeza de qualquer cache antigo (v1/v2) ainda
// guardado no navegador de quem já tinha instalado o app antes dessa
// mudança. v3: o app shell apontava pro nome do arquivo FONTE
// (dashboard-meta-ads.html), mas o que fica publicado de verdade é o build
// ofuscado (dashboard-meta-ads.github.html) — como o manifest.json também
// tinha esse mesmo engano no "start_url", no iPhone (que usa o manifest pra
// decidir que URL abrir quando o ícone da tela de início é tocado) isso
// resultava em erro 404 ao abrir o app instalado, mesmo o ícone tendo sido
// criado normalmente.
const CACHE_NAME = 'meta-ads-dashboard-v3';
const APP_SHELL = [
  './dashboard-meta-ads.github.html',
  './manifest.json',
  './icon-192.png',
  './icon-512.png'
];
